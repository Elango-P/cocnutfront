...
const Setting = {
   BLUETOOTH_PRINTER_SETTING: "bluetooth_printer_setting",
   STORE_ID_SETTING: "store_id_setting",
   ...
   VALIDATE_SHIFT_HOURS_ON_SALE_SETTLEMENT_ADD: "validate_shift_hours_on_sale_settlement_add",
