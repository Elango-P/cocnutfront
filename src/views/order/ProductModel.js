...
const BottomModal = (props) => {
  ...
  let getPurchaseData = () => {
    ...
    let param = {
      totalAmount:
        dataRef && dataRef.current.amount
          ? dataRef.current.amount
          : item?.amount,
  ...
  const initialValues = {
    ...
    amount: purchaseData?.amount
      ...
      : Number.GetFloat(item?.amount) ?? null,
    unit_price:
      Number.GetFloat(purchaseData?.unit_price) ??
      Number.GetFloat(item?.sale_price) ??
      null,
  ...
  const handleUpdate = () => {
    updateAction(initialValues,item?.orderProductId);
  };
  return (
    <View>
      <Modal
                ...
                >
                  ...
                  <View style={styles.infoHalf}>
                    <CurrencyInput
                      ...
                      name="amount"
                      control={control}
                      values={initialValues?.amount?.toString()}
                      noEditable={true}
                    />
                  </View>
                </View>
