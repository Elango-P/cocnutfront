class Permission {
  ...
  static LOCATION_SHOW_MAP_TAB = "location_show_map_tab";
  static LOCATION_SHOW_STOCK_TAB = "location_show_stock_tab";
  //Sync Permission

  static LOCATION_ALLOCATION_VIEW = "location_allocation_view";
